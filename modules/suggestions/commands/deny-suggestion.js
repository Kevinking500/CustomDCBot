...
module.exports.config = {
    ...
    description: localize('suggestions', 'deny-suggestion-description')
};

/*
 * Resolves the Suggestion by its stored messageID, then opens an optional-reason modal (customId encodes
...
module.exports.run = async function (interaction) {
    ...
    const modal = new ModalBuilder()
        .setCustomId(`suggestion-decision:deny:${suggestion.messageID}`)
        .setTitle(localize('suggestions', 'deny-suggestion-modal-title'))
        .addComponents(
